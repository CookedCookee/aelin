...
contract BalancerVestAMM {
    ...
    function deployPool(IVestAMMLibrary.CreateNewPool calldata _newPool) public returns (address) {
        ...
        address poolAddress = _createPool(newPoolParsed);

        _addLiquidity(poolAddress, _newPool.tokenAmtsIn, true);
    ...
    function addLiquidity(IVestAMMLibrary.AddLiquidity calldata _addLiquidityData) external {
